...
<link rel="preload" as="script" href="../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'contrib/dive/create-streamlit-exe';</script>
...
<li class="toctree-l1 has-children"><a class="reference internal" href="../info/index.html">Repository Information</a><details><summary><span class="toctree-toggle" role="presentation"><i class="fa-solid fa-chevron-down"></i></span></summary><ul>
<li class="toctree-l2"><a class="reference internal" href="../info/file-structure.html">Repository File Structure</a></li>
<li class="toctree-l2"><a class="reference internal" href="../info/docs-guide.html">Documentation Guide</a></li>
<li class="toctree-l2"><a class="reference internal" href="../info/release-guide.html">pymedphys Release Procedure</a></li>
</ul>
</details></li>
<li class="toctree-l1 has-children"><a class="reference internal" href="../setups/index.html">Workstation Setup Guides</a><details><summary><span class="toctree-toggle" role="presentation"><i class="fa-solid fa-chevron-down"></i></span></summary><ul>
<li class="toctree-l2"><a class="reference internal" href="../setups/setup-win.html">Windows Setup</a></li>
<li class="toctree-l2"><a class="reference internal" href="../setups/setup-linux.html">Linux Setup</a></li>
<li class="toctree-l2"><a class="reference internal" href="../setups/setup-mac.html">MacOS Setup</a></li>
</ul>
</details></li>
<li class="toctree-l1 has-children"><a class="reference internal" href="../tips/index.html">Tips &amp; Tricks</a><details><summary><span class="toctree-toggle" role="presentation"><i class="fa-solid fa-chevron-down"></i></span></summary><ul>
<li class="toctree-l2"><a class="reference internal" href="../tips/add-jupyter-kernel.html">Add Jupyter kernel with <em>poetry</em></a></li>
<li class="toctree-l2"><a class="reference internal" href="../tips/win-open-ssh.html">Setting up OpenSSH on Windows 10</a></li>
</ul>
</details></li>
<li class="toctree-l1 current active has-children"><a class="reference internal" href="index.html">Deep Dive</a><details open="open"><summary><span class="toctree-toggle" role="presentation"><i class="fa-solid fa-chevron-down"></i></span></summary><ul class="current">
<li class="toctree-l2"><a class="reference internal" href="why-open-source.html">Why Open Source?</a></li>
<li class="toctree-l2 current active"><a class="current reference internal" href="#">Creating a Streamlit Executable</a></li>
</ul>
</details></li>
</ul>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/pymedphys/pymedphys/edit/main/lib/pymedphys/docs/contrib/dive/create-streamlit-exe.md" target="_blank"
...
<span class="btn__text-container">Suggest edit</span>
      ...
      <li><a href="https://github.com/pymedphys/pymedphys/issues/new?title=Issue%20on%20page%20%2Fcontrib/dive/create-streamlit-exe.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../_sources/contrib/dive/create-streamlit-exe.md" target="_blank"
...
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#document-overview">Document overview</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#quick-version">Quick version</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#approach-overview">Approach overview</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#creating-a-self-contained-pymedphys-python-bundle">Creating a self contained PyMedPhys python bundle</a><ul class="nav section-nav flex-column">
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#justification">Justification</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#the-pyoxidizer-bzl-configuration-file">The <code class="docutils literal notranslate"><span class="pre">pyoxidizer.bzl</span></code> configuration file</a><ul class="nav section-nav flex-column">
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#files-mode">Files mode</a></li>
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#file-system-relative-resources-with-site-packages-name">File system relative resources with site-packages name</a></li>
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#use-standard-importer">Use standard importer</a></li>
</ul>
</li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#running-the-build">Running the build</a></li>
</ul>
</li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#the-use-and-setting-up-of-electron">The use and setting up of Electron</a><ul class="nav section-nav flex-column">
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#id1">Justification</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#setting-up-electron">Setting up Electron</a></li>
<li class="toc-h3 nav-item toc-entry"><a class="reference internal nav-link" href="#the-key-components-of-the-electron-code-base">The key components of the Electron code base</a><ul class="nav section-nav flex-column">
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#the-package-json-file">The <code class="docutils literal notranslate"><span class="pre">package.json</span></code> file</a></li>
<li class="toc-h4 nav-item toc-entry"><a class="reference internal nav-link" href="#the-main-ts-file">The <code class="docutils literal notranslate"><span class="pre">main.ts</span></code> file</a></li>
</ul>
</li>
</ul>
</li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#booting-the-streamlit-app-and-syncing-the-port-with-electron">Booting the streamlit app and syncing the port with Electron</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#building-for-all-oss-within-github-actions">Building for all OSs within GitHub Actions</a></li>
...
<div id="searchbox"></div>
  ...
  <section id="creating-a-streamlit-executable">
<h1>Creating a Streamlit Executable<a class="headerlink" href="#creating-a-streamlit-executable" title="Link to this heading">#</a></h1>
...
<h2>Quick version<a class="headerlink" href="#quick-version" title="Link to this heading">#</a></h2>
...
<h2>Approach overview<a class="headerlink" href="#approach-overview" title="Link to this heading">#</a></h2>
...
<h2>Creating a self contained PyMedPhys python bundle<a class="headerlink" href="#creating-a-self-contained-pymedphys-python-bundle" title="Link to this heading">#</a></h2>
<section id="justification">
<h3>Justification<a class="headerlink" href="#justification" title="Link to this heading">#</a></h3>
...
<h3>The <code class="docutils literal notranslate"><span class="pre">pyoxidizer.bzl</span></code> configuration file<a class="headerlink" href="#the-pyoxidizer-bzl-configuration-file" title="Link to this heading">#</a></h3>
...
<h4>Files mode<a class="headerlink" href="#files-mode" title="Link to this heading">#</a></h4>
...
<h4>File system relative resources with site-packages name<a class="headerlink" href="#file-system-relative-resources-with-site-packages-name" title="Link to this heading">#</a></h4>
...
<h4>Use standard importer<a class="headerlink" href="#use-standard-importer" title="Link to this heading">#</a></h4>
...
<h2>The use and setting up of Electron<a class="headerlink" href="#the-use-and-setting-up-of-electron" title="Link to this heading">#</a></h2>
<section id="id1">
<h3>Justification<a class="headerlink" href="#id1" title="Link to this heading">#</a></h3>
...
<h3>Setting up Electron<a class="headerlink" href="#setting-up-electron" title="Link to this heading">#</a></h3>
<p>To set up the Electron code base I began with the following boilerplate code:</p>
<blockquote>
<div><p><a class="github reference external" href="https://github.com/szwacz/electron-boilerplate">szwacz/electron-boilerplate</a></p>
</div></blockquote>
...
<h3>The key components of the Electron code base<a class="headerlink" href="#the-key-components-of-the-electron-code-base" title="Link to this heading">#</a></h3>
<p>Below is a short overview of the key components of the Electron application
code base.</p>
<section id="the-package-json-file">
<h4>The <code class="docutils literal notranslate"><span class="pre">package.json</span></code> file<a class="headerlink" href="#the-package-json-file" title="Link to this heading">#</a></h4>
...
build:</p>
<div class="highlight-json notranslate"><div class="highlight"><pre><span></span><span class="w">    </span><span class="nt">&quot;directories&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nt">&quot;buildResources&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;resources&quot;</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">    </span><span class="nt">&quot;extraResources&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">[</span>
<span class="w">      </span><span class="p">{</span>
<span class="w">        </span><span class="nt">&quot;from&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;python&quot;</span><span class="p">,</span>
<span class="w">        </span><span class="nt">&quot;to&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;python&quot;</span><span class="p">,</span>
...
<h4>The <code class="docutils literal notranslate"><span class="pre">main.ts</span></code> file<a class="headerlink" href="#the-main-ts-file" title="Link to this heading">#</a></h4>
...
<div class="highlight-typescript notranslate"><div class="highlight"><pre><span></span><span class="nx">appStreamlitServer</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">spawn</span><span class="p">(</span><span class="s2">&quot;./pymedphys&quot;</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;gui&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;--electron&quot;</span><span class="p">],</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">cwd</span><span class="o">:</span><span class="w"> </span><span class="kt">path.join</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">resourcesPath</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;python&quot;</span><span class="p">),</span>
<span class="p">});</span>
</pre></div>
</div>
<blockquote>
...
<div class="highlight-typescript notranslate"><div class="highlight"><pre><span></span><span class="nx">streamlitPortDelegate</span><span class="p">.</span><span class="nx">promise</span><span class="p">.</span><span class="nx">then</span><span class="p">((</span><span class="nx">port</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="kd">const</span><span class="w"> </span><span class="nx">pymedphysAppUrl</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">url</span><span class="p">.</span><span class="nx">format</span><span class="p">({</span>
<span class="w">    </span><span class="nx">pathname</span><span class="o">:</span><span class="w"> </span><span class="sb">`localhost:</span><span class="si">${</span><span class="nx">port</span><span class="si">}</span><span class="sb">`</span><span class="p">,</span>
...
<span class="w">    </span><span class="nx">slashes</span><span class="o">:</span><span class="w"> </span><span class="kt">true</span><span class="p">,</span>
<span class="w">  </span><span class="p">});</span>

<span class="w">  </span><span class="nx">mainWindow</span><span class="p">.</span><span class="nx">loadURL</span><span class="p">(</span><span class="nx">pymedphysAppUrl</span><span class="p">);</span>
<span class="p">});</span>
</pre></div>
</div>
<blockquote>
...
ready:</p>
<div class="highlight-typescript notranslate"><div class="highlight"><pre><span></span><span class="nx">appStreamlitServer</span><span class="p">.</span><span class="nx">stdout</span><span class="p">.</span><span class="nx">once</span><span class="p">(</span><span class="s2">&quot;data&quot;</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="nx">data</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="kd">const</span><span class="w"> </span><span class="nx">stdoutJson</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nb">JSON</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="sb">`</span><span class="si">${</span><span class="nx">data</span><span class="si">}</span><span class="sb">`</span><span class="p">);</span>
<span class="w">  </span><span class="kd">const</span><span class="w"> </span><span class="nx">port</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">stdoutJson</span><span class="p">[</span><span class="s2">&quot;port&quot;</span><span class="p">];</span>

<span class="w">  </span><span class="nx">streamlitPortDelegate</span><span class="p">.</span><span class="nx">resolve</span><span class="p">(</span><span class="nx">port</span><span class="p">);</span>
<span class="p">});</span>
</pre></div>
</div>
<blockquote>
...
<h2>Booting the streamlit app and syncing the port with Electron<a class="headerlink" href="#booting-the-streamlit-app-and-syncing-the-port-with-electron" title="Link to this heading">#</a></h2>
...
<div class="highlight-json notranslate"><div class="highlight"><pre><span></span><span class="p">{</span><span class="w"> </span><span class="nt">&quot;port&quot;</span><span class="p">:</span><span class="w"> </span><span class="mi">8051</span><span class="w"> </span><span class="p">}</span>
</pre></div>
</div>
...
<h2>Building for all OSs within GitHub Actions<a class="headerlink" href="#building-for-all-oss-within-github-actions" title="Link to this heading">#</a></h2>
...
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="p p-Indicator">-</span><span class="w"> </span><span class="nt">name</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">Build Binary</span>
<span class="w">  </span><span class="nt">if</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">matrix.task == &#39;build&#39;</span>
<span class="w">  </span><span class="nt">run</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">|</span>
<span class="w">    </span><span class="no">poetry run pymedphys dev build --install</span>
</pre></div>
</div>
<blockquote>
...
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="p p-Indicator">-</span><span class="w"> </span><span class="nt">uses</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">actions/upload-artifact@v3</span>
<span class="w">  </span><span class="nt">if</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">matrix.task == &#39;build&#39;</span>
<span class="w">  </span><span class="nt">with</span><span class="p">:</span>
<span class="w">    </span><span class="nt">name</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">PyMedPhysApp-${{ runner.os }}</span>
<span class="w">    </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">|</span>
<span class="w">      </span><span class="no">js/app/dist/*.dmg</span>
<span class="w">      </span><span class="no">js/app/dist/*.exe</span>
<span class="w">      </span><span class="no">js/app/dist/*.snap</span>
<span class="w">      </span><span class="no">js/app/dist/*.AppImage</span>
<span class="w">      </span><span class="no">!js/app/dist/*unpacked/</span>
</pre></div>
</div>
<blockquote>
