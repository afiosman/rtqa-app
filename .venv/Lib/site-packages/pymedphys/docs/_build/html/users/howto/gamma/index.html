...
<link rel="preload" as="script" href="../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'users/howto/gamma/index';</script>
    <link rel="canonical" href="https://docs.pymedphys.com/users/howto/gamma/index.html" />
    <link rel="icon" href="../../../_static/pymedphys.svg"/>
    <link rel="index" title="Index" href="../../../genindex.html" />
    <link rel="search" title="Search" href="../../../search.html" />
    <link rel="next" title="Speeding up gamma calculations" href="speed-up.html" />
...
<li class="toctree-l2 current active has-children"><a class="current reference internal" href="#">Gamma</a><details open="open"><summary><span class="toctree-toggle" role="presentation"><i class="fa-solid fa-chevron-down"></i></span></summary><ul>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/pymedphys/pymedphys/edit/main/lib/pymedphys/docs/users/howto/gamma/index.rst" target="_blank"
...
<span class="btn__text-container">Suggest edit</span>
      ...
      <li><a href="https://github.com/pymedphys/pymedphys/issues/new?title=Issue%20on%20page%20%2Fusers/howto/gamma/index.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../_sources/users/howto/gamma/index.rst" target="_blank"
...
<ul>
<li class="toctree-l1"><a class="reference internal" href="speed-up.html">Speeding up gamma calculations</a></li>
<li class="toctree-l1"><a class="reference internal" href="1D-from-csv.html">Gamma from 1D ASCII data</a><ul>
<li class="toctree-l2"><a class="reference internal" href="1D-from-csv.html#getting-the-demo-csv-files">Getting the demo .csv files</a></li>
<li class="toctree-l2"><a class="reference internal" href="1D-from-csv.html#calculate-gamma">Calculate gamma</a></li>
<li class="toctree-l2"><a class="reference internal" href="1D-from-csv.html#plot-the-histogram-of-gamma-index">Plot the histogram of gamma index</a></li>
<li class="toctree-l2"><a class="reference internal" href="1D-from-csv.html#display-gamma-together-with-dose-points">Display gamma together with dose points</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="effect-of-noise.html">The Effects of Noise on Gamma</a><ul>
<li class="toctree-l2"><a class="reference internal" href="effect-of-noise.html#defining-an-example-dose-reference">Defining an example dose reference</a></li>
<li class="toctree-l2"><a class="reference internal" href="effect-of-noise.html#defining-an-example-evaluation-dose">Defining an example evaluation dose</a></li>
<li class="toctree-l2"><a class="reference internal" href="effect-of-noise.html#seeing-a-dose-difference">Seeing a dose difference</a></li>
<li class="toctree-l2"><a class="reference internal" href="effect-of-noise.html#evaluation-gamma">Evaluation Gamma</a></li>
<li class="toctree-l2"><a class="reference internal" href="effect-of-noise.html#investigating-the-effect-of-noise">Investigating the effect of noise</a></li>
<li class="toctree-l2"><a class="reference internal" href="effect-of-noise.html#conclusion">Conclusion</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="from-dicom.html">Gamma from DICOM</a><ul>
<li class="toctree-l2"><a class="reference internal" href="from-dicom.html#getting-the-demo-dicom-files">Getting the demo DICOM files</a></li>
<li class="toctree-l2"><a class="reference internal" href="from-dicom.html#calculate-and-display-gamma">Calculate and display Gamma</a></li>
<li class="toctree-l2"><a class="reference internal" href="from-dicom.html#plotting-the-dose-and-the-gamma">Plotting the Dose and the Gamma</a></li>
</ul>
</li>
</ul>
</div>
