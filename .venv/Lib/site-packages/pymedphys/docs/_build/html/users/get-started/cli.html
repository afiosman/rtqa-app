...
<html lang="en" data-content_root="../../" >
  ...
  <head>
    ...
    <title>Using the CLI &#8212; PyMedPhys</title>
...
<link rel="preload" as="script" href="../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'users/get-started/cli';</script>
    <link rel="canonical" href="https://docs.pymedphys.com/users/get-started/cli.html" />
...
<li class="toctree-l2"><a class="reference internal" href="quick-start.html">Quick Start Guide</a></li>
<li class="toctree-l2 current active"><a class="current reference internal" href="#">Using the CLI</a></li>
</ul>
</details></li>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/pymedphys/pymedphys/edit/main/lib/pymedphys/docs/users/get-started/cli.rst" target="_blank"
...
<span class="btn__text-container">Suggest edit</span>
      ...
      <li><a href="https://github.com/pymedphys/pymedphys/issues/new?title=Issue%20on%20page%20%2Fusers/get-started/cli.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../_sources/users/get-started/cli.rst" target="_blank"
...
<h1>Using the CLI<a class="headerlink" href="#using-the-cli" title="Link to this heading">#</a></h1>
<p>PyMedPhys exposes a range of its library functions to the command line as a
command line interface (CLI). This provides the benefit of being able to call
PyMedPhys functions from a range of locations such as:</p>
<ul class="simple">
<li><p>Other programming languages</p></li>
<li><p>Windows scheduler</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">.bat</span></code> and <code class="docutils literal notranslate"><span class="pre">.sh</span></code> files</p></li>
</ul>
<p>You can find the technical reference for the command line tools
<a class="reference internal" href="../ref/cli/index.html"><span class="doc">here</span></a>.</p>
</section>
