...
<html lang="en" data-content_root="../../" >
  ...
  <head>
    ...
    <title>Elekta Logfile Decoding and Indexing &#8212; PyMedPhys</title>
...
<link rel="preload" as="script" href="../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'users/background/elekta-logfiles';</script>
    <link rel="canonical" href="https://docs.pymedphys.com/users/background/elekta-logfiles.html" />
    <link rel="icon" href="../../_static/pymedphys.svg"/>
    <link rel="index" title="Index" href="../../genindex.html" />
    <link rel="search" title="Search" href="../../search.html" />
    <link rel="next" title="Technical Reference" href="../ref/index.html" />
    <link rel="prev" title="Automatic Contouring Project" href="autocontouring.html" />
...
<li class="toctree-l2"><a class="reference internal" href="autocontouring.html">Automatic Contouring Project</a></li>
<li class="toctree-l2 current active"><a class="current reference internal" href="#">Elekta Logfile Decoding and Indexing</a></li>
</ul>
</details></li>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/pymedphys/pymedphys/edit/main/lib/pymedphys/docs/users/background/elekta-logfiles.rst" target="_blank"
...
<span class="btn__text-container">Suggest edit</span>
      ...
      <li><a href="https://github.com/pymedphys/pymedphys/issues/new?title=Issue%20on%20page%20%2Fusers/background/elekta-logfiles.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../_sources/users/background/elekta-logfiles.rst" target="_blank"
...
<div id="jb-print-docs-body" class="onlyprint">
    <h1>Elekta Logfile Decoding and Indexing</h1>
    <!-- Table of contents -->
...
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#project-aim">Project aim</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#presentations-related-to-this-project">Presentations Related to this Project</a></li>
...
<div id="searchbox"></div>
  ...
  <section id="elekta-logfile-decoding-and-indexing">
<h1>Elekta Logfile Decoding and Indexing<a class="headerlink" href="#elekta-logfile-decoding-and-indexing" title="Link to this heading">#</a></h1>
<section id="project-aim">
<h2>Project aim<a class="headerlink" href="#project-aim" title="Link to this heading">#</a></h2>
...
<ul class="simple">
<li><p>Linac reported MLC and Jaw positions are not independent from the machine and
a fault resulting in mispositioning of the collimation may not be reported
within the log files.</p></li>
<li><p>The treatment planning system beam models (as well as potentially any
independent calculation software) may not accurately model the MLCs <a class="footnote-reference brackets" href="#id2" id="id1" role="doc-noteref"><span class="fn-bracket">[</span>1<span class="fn-bracket">]</span></a>, and
therefore, checking leaf position, without a dose measurement, may not be
sufficient verification.</p></li>
</ul>
</div>
</section>
<section id="presentations-related-to-this-project">
<h2>Presentations Related to this Project<a class="headerlink" href="#presentations-related-to-this-project" title="Link to this heading">#</a></h2>
...
<ul class="simple">
<li><p><a class="reference external" href="http://simonbiggs.net/epsm2018">Comparing the Reported MLC and Jaw Positions Between Mosaiq and Elekta Linac Delivery at EPSM 2018</a>.</p></li>
<li><p>Open source tools for converting 40 ms resolution trf Elekta log files into
DICOM RT Plan format for log file-derived dose reconstruction at ICCR 2019.</p></li>
</ul>
</section>
<section id="details">
<h2>Details<a class="headerlink" href="#details" title="Link to this heading">#</a></h2>
<p>The diagnostic backups of an Elekta Linac contain the trf log files which detail
...
<p>The log files contain information such as MLC and Jaw positions, MU delivered,
gantry
...
<p>These log files can be extracted and then associated to a patient’s record
...
<p>Post indexing these log files can be decoded into csv format for human
...
<p>Gholampourkashi, Sara, et al. “Monte Carlo and analytic modeling of an Elekta
Infinity linac with Agility MLC: Investigating the significance of accurate
model parameters for small radiation fields.”
<em>Journal of Applied Clinical Medical Physics</em> 20.1 (2019): 55-67. <a class="reference external" href="https://doi.org/10.1002/acm2.12485">https://doi.org/10.1002/acm2.12485</a>.</p>
</aside>
</aside>
</section>
</section>
...
<div class="prev-next-area">
    <a class="left-prev"
       href="autocontouring.html"
       title="previous page">
      <i class="fa-solid fa-angle-left"></i>
      <div class="prev-next-info">
        <p class="prev-next-subtitle">previous</p>
        <p class="prev-next-title">Automatic Contouring Project</p>
      </div>
    </a>
    <a class="right-next"
       href="../ref/index.html"
